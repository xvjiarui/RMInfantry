...
{	
	init();
	//testing
	InfantryJudge.m_data[1] = 2.71828;
	InfantryJudge.m_data[2] = -8848;
	BSP_TIM_Start();
	while (1)  {	
			...
			if(ticks_msimg%50==0)
			{
				...
				// {
					if (DBUS_ReceiveData.rc.switch_left != 2)
					{
						...
						tft_prints(0, 2,"ID:%d S:%d %d", InfantryID, status, ticks_msimg);
					...
					else
					{
						...
						tft_prints(0, 8, "OS:%d %f", InfantryJudge.OverShootSpeedDecrease, InfantryJudge.OverShootSpeedDecrease/(2000.0f - InfantryJudge.LastBlood));
						tft_prints(0, 9, "OF:%d %f", InfantryJudge.OverShootFreqDecrease, InfantryJudge.OverShootFreqDecrease/(2000.0f - InfantryJudge.LastBlood));
						tft_prints(0, 10, "OP:%d %f", InfantryJudge.OverPowerDecrease, InfantryJudge.OverPowerDecrease/(2000.0f - InfantryJudge.LastBlood));
