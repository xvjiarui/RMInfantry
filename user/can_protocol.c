...
void can_init(void)
{
	...
	/* CAN GPIO init */
	// CAN_Rx Pin
	gpio_init(CAN_Rx_GPIO,GPIO_Mode_AF,GPIO_OType_PP,GPIO_Speed_50MHz,GPIO_PuPd_UP);
	//CAN_Rx_GPIO->gpio_init(GPIO_Speed_50MHz, GPIO_Mode_AF, GPIO_OType_PP, GPIO_PuPd_UP);

	// CAN_Tx Pin
	gpio_init(CAN_Tx_GPIO,GPIO_Mode_AF,GPIO_OType_PP,GPIO_Speed_50MHz,GPIO_PuPd_NOPULL);
